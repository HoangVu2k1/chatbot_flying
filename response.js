const responseObj = {
  "Bắt đầu": "Chào bạn!Tôi có thể giúp gì cho bạn ?",
  "Bạn có thể làm gì": "Tôi có thể giúp bạn tìm kiếm những thông tin tối ưu về chuyến bay mà bạn cần!",
  "Chuyến bay từ quy nhơn đến hà nội sớm nhất": "Chuyến bay sớm nhất sẽ khởi hành vào ngày 12/11 vào lúc 5h30",
  "Chuyến bay từ quy nhơn đến Tp. Hồ chí minh sớm nhất": "Chuyến bay sớm nhất sẽ khởi hành vào ngày 09/11 vào lúc 6h00",
  today: new Date().toDateString(),
  time: new Date().toLocaleTimeString(),
};
function getBotResponses(input) {
    if(input =="Bắt đầu"){
